<div :class="{'hidden': open, 'flex': !opoen }" class="relative justify-center">
    ...
    <div x-show="open" x-transition:enter="transition duration-300 ease-out"
        ...
        <div
            class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 bg-zinc-700 bg-opacity-50 text-center sm:block sm:p-0">
